...
# This Function will decompose audio to its feature set for the prediction by applying ML Model #
...
def new_upload_file(filename):
    try:
        ...
        output = 'The song or Audio:' + str(filename) + ' belongs to ' + pred[
            0] + ' genre at ' + score + ' Or it may have more acoustic similarity to ' + pred[
                     0] + ' genre as per our ML model. ' \
                          '_____________________________________________________________________________________' \
                          '____________________________________________________________________________________' \
                          '  Kindly note that because our ML model has a 90% score accuracy ' \
                          'there is a 10 % chance of misclassification. But another inference can be taken in theory ' \
                          ' that '\
                          ...
                          'this audio has a <div class=my-result><b>' + pred[
                     0] + '</b></div> genre signature .             ' \
